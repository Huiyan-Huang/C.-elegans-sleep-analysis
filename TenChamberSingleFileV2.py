...
path=r'C:\Users\Hart_E5430\Desktop\Sleep movies\Results\yyyy.mm.dd.N2.12h.txt'
ChamberN=10
...
titlelist=['name','entry/h','exit/h','duration/h',
...
for i in range(len(StageAnalysis)):
        outputlist.append([i+1]+[Qentry[i]]+[Qexit[i]]+[Qduration[i]]+
                                [correctedQ_min[i]]+[tAPD[i]]+[tQepisodes[i]]
                                +[tQfreq[i]]+[peak_fQ[i]])
